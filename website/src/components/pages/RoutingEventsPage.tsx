...
import { ArrowRightLeft, BellRing, PlusCircle, TrendingUp } from 'lucide-react'
...
> = {
  ...
  gateway_entered: { label: 'New gateway', badge: 'green', icon: PlusCircle },
  score_swing: { label: 'Score swing', badge: 'orange', icon: TrendingUp },
}
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-[#8d96aa]">
            Live changes in success-rate based routing — leader flips, new gateways, and score swings.
          </p>
        </div>
