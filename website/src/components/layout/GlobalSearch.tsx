...
const ALL_SEARCH_GROUPS: SearchGroup[] = [
  {
    ...
    items: [
      ...
      { to: '/audit?routing_kind=rule_based', label: 'Rule & Volume', hint: 'Decision Audit', icon: Activity, keywords: ['rule based', 'volume', 'rules'] },
      { to: '/audit?routing_kind=debit_routing', label: 'Debit Routing', hint: 'Decision Audit', icon: Network, keywords: ['debit', 'network', 'card'] },
