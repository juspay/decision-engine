...
const ALL_SEARCH_GROUPS: SearchGroup[] = [
  {
    ...
    items: [
      ...
      { to: '/audit', label: 'Decision Audit', icon: FileSearch, keywords: ['payment', 'inspect', 'logs', 'transactions'] },
      { to: '/audit?routing_kind=multi_objective', label: 'Multi-objective', hint: 'Decision Audit', icon: FileSearch, keywords: ['sr', 'success rate', 'multi objective', 'transactions'] },
      { to: '/audit?routing_kind=rule_based', label: 'Rule & Volume', hint: 'Decision Audit', icon: FileSearch, keywords: ['rule based', 'volume', 'rules'] },
      { to: '/audit?routing_kind=debit_routing', label: 'Debit Routing', hint: 'Decision Audit', icon: CreditCard, keywords: ['debit', 'network', 'card'] },
  ...
  },
  {
    heading: 'Routing',
    items: [
      { to: '/routing', label: 'Routing Hub', icon: Route, keywords: ['strategies', 'algorithms', 'overview'] },
      { to: '/routing/sr', label: 'Multi Objective', icon: Target, keywords: ['sr', 'success rate', 'auth rate'] },
      ...
      { to: '/routing/sr?tab=manual', label: 'Scoring Defaults', hint: 'Manual Config', icon: SlidersHorizontal, keywords: ['sr', 'scoring', 'defaults', 'weights', 'bucket size', 'hedging', 'payment type override'] },
      { to: '/routing/sr?tab=manual&section=elimination', label: 'Elimination', hint: 'Manual Config', icon: Ban, keywords: ['sr', 'eliminate', 'threshold', 'latency', 'auth rate', 'drop psp', 'remove gateway'] },
      { to: '/routing/sr?tab=manual&section=dimensions', label: 'SR Dimensions', hint: 'Manual Config', icon: Layers, keywords: ['sr', 'dimensions', 'split', 'clusters', 'udf', 'card network', 'currency', 'country', 'bin'] },
      ...
      { to: '/routing/sr?tab=cost&section=ingestion', label: 'Automatic Ingestion', hint: 'Data Ingestion', icon: Database, keywords: ['cost', 'ingest', 'credentials', 'sftp', 'connector', 'automatic', 'scheduled'] },
      ...
      { to: '/routing/rules', label: 'Rule Based', icon: SignpostBig, keywords: ['euclid', 'rules', 'conditions'] },
      { to: '/routing/volume', label: 'Volume Split', icon: PieChart, keywords: ['distribution', 'percentage', 'weights'] },
      { to: '/routing/debit', label: 'Debit Routing', icon: CreditCard, keywords: ['debit', 'network', 'card'] },
      { to: '/routing/ab-testing', label: 'A/B Testing', icon: FlaskConical, keywords: ['experiment', 'split test', 'ab'] },
    ],
  },
  {
    heading: 'Simulation',
