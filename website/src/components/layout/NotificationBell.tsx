...
import { ArrowRightLeft, Bell, PlusCircle, TrendingUp } from 'lucide-react'
...
const EVENT_ICONS: Record<RoutingEventType, React.ElementType> = {
  ...
  gateway_entered: PlusCircle,
  score_swing: TrendingUp,
}

const EVENT_ICON_CLASSES: Record<RoutingEventType, string> = {
  leader_changed: 'text-sky-600 dark:text-sky-300',
  gateway_entered: 'text-emerald-600 dark:text-emerald-300',
  score_swing: 'text-orange-600 dark:text-orange-300',
}
