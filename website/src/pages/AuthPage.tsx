  ...
  return (
    <div className="dark relative min-h-screen overflow-hidden bg-white text-slate-900 dark:bg-[#030507] dark:text-white">
      ...
      <div className="relative z-10 grid min-h-screen lg:grid-cols-[1.06fr_0.94fr]">
        <section className="flex min-h-[44vh] flex-col border-b border-slate-200 dark:border-white/6 lg:min-h-screen lg:border-b-0 lg:border-r lg:border-[#1d1d23] px-6 py-8 sm:px-10 lg:px-14 lg:py-12 xl:px-16">
          <div className="pt-2">
            <img
