...
export const PAYMENT_METHODS: Record<string, string[]> = {
  ...
  bank_debit: ['ach', 'sepa', 'bacs', 'becs', 'eft_debit_order', 'sepa_guarenteed_debit'],
  bank_transfer: ['ach', 'sepa', 'sepa_bank_transfer', 'bacs', 'multibanco', 'pix', 'pse', 'permata_bank_transfer', 'bca_bank_transfer', 'bni_va', 'bri_va', 'cimb_va', 'danamon_va', 'mandiri_va', 'local_bank_transfer', 'instant_bank_transfer', 'pix_key', 'pix_emv', 'pix_qr', 'pix_automatico_push', 'pix_automatico_qr', 'payshap', 'payshap_proxy', 'instant_bank_transfer_finland', 'instant_bank_transfer_poland', 'indonesian_bank_transfer'],
  wallet: ['amazon_pay', 'apple_pay', 'google_pay', 'paypal', 'ali_pay', 'ali_pay_hk', 'dana', 'mb_way', 'mobile_pay', 'samsung_pay', 'twint', 'vipps', 'touch_n_go', 'swish', 'we_chat_pay', 'go_pay', 'gcash', 'momo', 'kakao_pay', 'cashapp', 'mifinity', 'paze', 'bluecode', 'skrill', 'paysera', 'venmo', 'revolut_pay'],
  pay_later: ['affirm', 'alma', 'afterpay_clearpay', 'klarna', 'pay_bright', 'atome', 'walley', 'flexiti', 'breadpay', 'payjustnow'],
  upi: ['upi_collect', 'upi_intent', 'upi_qr'],
  ...
  bank_redirect: ['giropay', 'ideal', 'sofort', 'eft', 'eps', 'bancontact_card', 'blik', 'local_bank_redirect', 'online_banking_thailand', 'online_banking_czech_republic', 'online_banking_finland', 'online_banking_fpx', 'online_banking_poland', 'online_banking_slovakia', 'przelewy24', 'trustly', 'bizum', 'interac', 'open_banking_uk', 'open_banking_pis', 'open_banking'],
  gift_card: ['givex', 'pay_safe_card', 'bhn_card_network'],
  card_redirect: ['knet', 'benefit', 'momo_atm', 'card_redirect'],
  real_time_payment: ['fps', 'duit_now', 'prompt_pay', 'viet_qr', 'qris'],
