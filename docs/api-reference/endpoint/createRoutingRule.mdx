...
For more advanced rule examples, including `volume_split_priority`, `enum_variant_array`, `number_array`, and `number_comparison_array`, see [Advanced Routing Example](../../api-refs/routing-advanced-example.mdx).
...
- [Advanced Routing Example](../../api-refs/routing-advanced-example.mdx)
