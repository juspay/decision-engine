...
pub struct DomainDeciderRequest {
    pub order_reference: ETO::Order,
    pub order_metadata: ETOMV2::OrderMetadataV2,
    pub txn_detail: ETTD::TxnDetail,
    pub txn_offer_details: Option<Vec<ETTOD::TxnOfferDetail>>,
    pub txn_card_info: ETCa::txn_card_info::TxnCardInfo,
    pub merchant_account: ETM::merchant_account::MerchantAccount,
    pub card_token: Option<String>,
    pub txn_type: Option<String>,
    pub should_create_mandate: Option<bool>,
    pub enforce_gateway_list: Option<Vec<String>>,
    pub priority_logic_output: Option<GatewayPriorityLogicOutput>,
    pub priority_logic_script: Option<String>,
    pub is_edcc_applied: Option<bool>,
    pub should_consume_result: Option<bool>,
}
    ...
    pub async fn to_domain_decider_request(&self) -> DomainDeciderRequest {
        DomainDeciderRequest {
            order_reference: ETO::Order {
                ...
                merchant_id: ETM::id::to_merchant_id(self.merchant_id.clone()),
                order_id: ETO::id::to_order_id(self.payment_info.payment_id.clone()),
                status: ETO::OrderStatus::Created,
                description: None,
                customer_id: self.payment_info.customer_id.clone(),
                udfs: self
                    .payment_info
                    .udfs
                    .clone()
                    .unwrap_or(UDFs(HashMap::new())),
                preferred_gateway: self.payment_info.preferred_gateway.clone(),
                product_id: None,
                order_type: ETO::OrderType::from_txn_object_type(
                    self.payment_info.payment_type.clone(),
                ),
                metadata: self.payment_info.metadata.clone(),
                internal_metadata: self.payment_info.internal_metadata.clone(),
            },
            should_consume_result: None,
            order_metadata: ETOMV2::OrderMetadataV2 {
            ...
            txn_detail: ETTD::TxnDetail {
                ...
                txn_id: ETId::to_transaction_id(self.payment_info.payment_id.clone()),
                ...
                is_emi: Some(self.payment_info.is_emi.clone().unwrap_or(false)),
                emi_bank: self.payment_info.emi_bank.clone(),
                emi_tenure: self.payment_info.emi_tenure.clone(),
                txn_uuid: self.payment_info.payment_id.clone(),
                merchant_gateway_account_id: None,
                txn_amount: Some(ETMo::Money::from_double(self.payment_info.amount)),
                txn_object_type: Some(self.payment_info.payment_type.clone()),
                source_object: Some(self.payment_info.payment_method.clone()),
                source_object_id: None,
                currency: self.payment_info.currency.clone(),
                country: self.payment_info.country.clone(),
                net_amount: Some(ETMo::Money::from_double(self.payment_info.amount)),
                surcharge_amount: None,
                tax_amount: None,
                internal_metadata: self.payment_info.internal_metadata.clone().map(Secret::new),
            ...
            txn_card_info: ETCa::txn_card_info::TxnCardInfo {
                ...
                card_issuer_bank_name: self.payment_info.card_issuer_bank_name.clone(),
                card_switch_provider: self.payment_info.card_switch_provider.clone(),
                card_type: self.payment_info.card_type.clone(),
                name_on_card: None,
                date_created: OffsetDateTime::now_utc(),
                payment_method_type: self.payment_info.payment_method_type.to_string(),
                payment_method: self.payment_info.payment_method.clone(),
                payment_source: self.payment_info.payment_source.clone(),
                auth_type: self.payment_info.auth_type.clone(),
                partition_key: None,
            },
            merchant_account: ETM::merchant_account::load_merchant_by_merchant_id(
            ...
            card_token: None,
            txn_type: None,
            should_create_mandate: None,
            enforce_gateway_list: None,
            priority_logic_output: None,
            priority_logic_script: None,
            is_edcc_applied: Some(false),
        }
    }
}
