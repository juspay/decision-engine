...
diesel::allow_tables_to_appear_in_same_query!(
    card_brand_routes,card_info,co_badged_cards_info_test,emi_bank_code,feature,gateway_bank_emi_support,gateway_bank_emi_support_v2,gateway_card_info,gateway_outage,gateway_payment_method_flow,isin_routes,issuer_routes,juspay_bank_code,merchant_account,merchant_config,merchant_gateway_account,merchant_gateway_account_sub_info,merchant_gateway_card_info,merchant_gateway_payment_method_flow,merchant_iframe_preferences,merchant_priority_logic,payment_method,routing_algorithm,routing_algorithm_mapper,service_configuration,tenant_config,tenant_config_filter,token_bin_info,txn_card_info,txn_detail,txn_offer,txn_offer_detail,user_eligibility_info,);
