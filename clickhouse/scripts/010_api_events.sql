...
CREATE TABLE IF NOT EXISTS decision_engine_analytics.analytics_api_events_parse_errors (
    topic String,
    partition Int64,
    offset Int64,
    raw String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS decision_engine_analytics.analytics_api_events_parse_errors_mv
TO decision_engine_analytics.analytics_api_events_parse_errors AS
SELECT
    _topic AS topic,
