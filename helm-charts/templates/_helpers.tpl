...
{{/*
Default PostgreSQL migration script
*/}}
{{- define "decision-engine.defaultPgMigrationScript" -}}
-- Default PostgreSQL migration script for Decision Engine
...
-- Additional tables would follow the same pattern as in the up.sql script
{{- end }}
