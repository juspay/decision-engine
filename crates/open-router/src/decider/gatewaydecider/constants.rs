...
use crate::redis::types::{self as SC, ServiceConfigKey};
...
pub fn internalDefaultEliminationV2SuccessRate1AndNPrefix(val: String) -> INTERNAL_DEFAULT_ELIMINATION_V2_SUCCESS_RATE_1_AND_N {
...
pub fn getTokenRepeatMandateGatewayKey(val: String
...
impl SC::ServiceConfigKey for MANDATE_GUEST_CHECKOUT_SUPPORTED_GATEWAYS {
    fn get_key(&self) -> String {
        format!(
            ...
            self.0.as_ref().map_or("DEFAULT".to_string(), |s| s.peek().to_string())
        )
    }
}

pub fn getmandateGuestCheckoutKey(val: Option<Secret<String>>) -> MANDATE_GUEST_CHECKOUT_SUPPORTED_GATEWAYS {
...
pub fn getTokenRepeatCvvLessBankCodeKey(val: Option<Secret<String>>) -> TOKEN_REPEAT_CVVLESS_SUPPORTED_BANKS {
...
pub fn enable_gateway_selection_based_on_optimized_sr_input(val: String) -> ENABLE_GATEWAY_SELECTION_BASED_ON_OPTIMIZED_SR_INPUT {
...
pub fn enable_gateway_selection_based_on_sr_v3_input(val: String) -> ENABLE_GATEWAY_SELECTION_BASED_ON_SR_V3_INPUT {
