...
//     logErrorT(
//         "SERVICE_CONFIG_DECODE_FAIL",
//         &format!("{} : DECODE FAIL FOR VALUE, FALLING BACK TO PREVIOUS_VALUE", service_config.name),
//     );
...
//         Ok(x) => Ok(x),
//         Err(err) => {
//             L::logErrorV("Redis exists", &err.to_string());
//             Err(err)
//         }
//     }
// }
...
//         Ok(x) => Ok(x as i32),
//         Err(err) => {
//             L.logErrorV::<String>("Redis incr", &err.to_string());
//             Err(err.to_string())
//         }
//     }
// }
...
//         Ok(x) => Ok(x as i32),
//         Err(err) => {
//             L::logErrorV::<String>("Redis decr", &err);
//             Err(err.to_string())
//         }
//     }
// }
...
//         Ok(res) => Some(res),
//         Err(err) => {
//             L.logErrorV::<String>("getFromStream", &format!("{}", err));
//             None
//         }
//     }
// }
...
//         Ok(res) => res,
//         Err(err) => {
//             L::logErrorV::<String>("delFromStream", &format!("{}", err));
//             0
//         }
//     }
// }
...
//         Ok(R::Status(status)) => {
//             L.logErrorT("createStreamGroup", &Text::decode_utf8(&status));
//             false
//         }
//         Err(err) => {
//             L.logErrorV::<String>("createStreamGroup", &err);
//             false
//         }
//     }
// }
...
//         Ok(res) => res,
//         Err(err) => {
//             L.logErrorV::<String>("getStreamLength", &err.to_string());
//             0
//         }
//     }
// }
